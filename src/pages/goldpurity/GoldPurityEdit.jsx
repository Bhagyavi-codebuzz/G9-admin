...
const GoldPurityEdit = () => {
    const navigate = useNavigate();
    const location = useLocation();
    const [editGoldPurity, seteditGoldPurity] = useState(location.state?.goldpurity || {});
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await Axios.post(
                apiendpoints.editgoldPurity.replace(":id", editGoldPurity.id),
                form,
