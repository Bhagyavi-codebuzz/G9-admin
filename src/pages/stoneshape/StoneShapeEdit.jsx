...
const StoneShapeEdit = () => {
    const navigate = useNavigate();
    const location = useLocation();
    const [editStoneShape, setEditStoneShape] = useState(location.state?.stoneshape || {});
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await Axios.post(
                apiendpoints.editStoneShape.replace(":id", editStoneShape.id),
                form,
            ...
            if (res.data?.status) {
                ...
                navigate("/admin/materials/stoneshape");
            } else {
