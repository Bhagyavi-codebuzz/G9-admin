...
const Blog = () => {
    ...
    const fetchBlog = async () => {
        ...
        try {
            const res = await Axios.get(`${apiendpoints.blog}`, authorizationHeaders());
    ...
    const handleDelete = async () => {
        ...
        try {
            const res = await Axios.delete(apiendpoints.deleteBlog.replace(":id", deleteId), authorizationHeaders());
